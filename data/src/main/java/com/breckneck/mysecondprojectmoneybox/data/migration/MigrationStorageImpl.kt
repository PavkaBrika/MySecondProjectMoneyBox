...
private val APP_PREFERENCES_ITEM = "item"; //variable for SharedPreferences item
private val APP_PREFERENCES_MONEY = "money"; //variable for SharedPreferences money
private val APP_PREFERENCES_COST = "cost"; //variable for SharedPreferences cost
...
class MigrationStorageImpl(val context: Context): MigrationStorage {
    ...
    override fun migration() {
        val id = appSettings.getInt(APP_PREFERENCES_GOAL_ID, 1)
        if (id == 1) {
